...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.0f }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.0f        // (mm) Compression length applying to all extruders
  #endif
